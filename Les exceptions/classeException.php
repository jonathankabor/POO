...
/*Ainsi, nous voyons que l'on a accès aux attributs
protégés de la classe et qu'on peut réécrire les
méthodes__constructet__toString. Toutes les autres
méthodes sont finales, nous n'avons donc pas le droit de les réécrire.